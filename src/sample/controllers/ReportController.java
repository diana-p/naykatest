...
public class ReportController {
    ...
    public void initData() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            employeesData.add(new Employee(resultSet.getInt("id_empl"), name, resultSet.getString("position"), date, mark));
        }
        ...
        while (set.next()){
            ...
            for (int i = 0; i < numberRows; i++) {
                ...
                //заполнение календаря отметками о работе
                ObservableList<String> markList = FXCollections.observableArrayList("В", "Я", "Б", "До", "К", "Н", "Ож", "ОТ"
                        , "Рв", "У", "Хд");

                day.setCellFactory(ComboBoxTableCell.forTableColumn(markList));
                day.setOnEditCommit((TableColumn.CellEditEvent<Employee, String> event) -> {
                    ...
                    dbHandler.setMark(mark, employee, d, month);
                });
            }
        }
    }
